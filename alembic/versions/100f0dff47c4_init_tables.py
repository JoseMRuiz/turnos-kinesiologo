...
Revision ID: 100f0dff47c4
Revises: 
Create Date: 2025-10-29 12:36:10.036950
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_turnos_user_id'), 'turnos', ['user_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_turnos_user_id'), table_name='turnos')
